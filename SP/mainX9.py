...
parser.add_argument('--tile', type=float, default=   0.9999999999)
parser.add_argument('--gamma_ref', type=float, default=None)
parser.add_argument('--gamma_p', type=float, default=0.0000000001)
...
if __name__ == '__main__':
    random = np.random.RandomState(5324645)
    # num_type = 4
