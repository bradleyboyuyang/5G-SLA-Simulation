...
class Likelihood:
    ...
    def logW(self, n_served, flow_id):
        ...
        for flow in range(self.num_type):
            ...
            else: ## lower priority, notice to consider the initial case
                if n_served[flow] == 0:
                    assert packet_infos[0].last_arrival == 0
                    assert packet_infos[0].interarrival > self.first_nonempty_time, (packet_infos[0].interarrival, self.first_nonempty_time)
